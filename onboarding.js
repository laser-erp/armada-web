...
(function(){
  ...
  const TOURS={
    ...
    driver:[
      {
        title:'Главная',
        body:'<p>Сводка дня: километры, заработок и статус смены.</p><p>Баннеры «Выехал» / «Прибыл» и кнопки смены статуса на Главной. Переписка со сменой и осмотр — во вкладке «ЕТО», карточки заказов — в «Заявки».</p>',
        target:'btn-home',
        placement:'top'
      },
      {
        title:'ЕТО',
        body:'<p>Ежедневный техосмотр и лента сообщений смены: авто, одометр, жидкости, свет.</p><p>Откройте смену на Главной — шаги осмотра здесь. Без ЕТО заказы в работу не берутся.</p>',
        target:'btn-eto',
        placement:'top'
      },
      {
